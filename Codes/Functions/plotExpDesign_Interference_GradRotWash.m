function plotExpDesign_Interference_GradRotWash(prot,col)
% prot - protocol
% col- colors
...
for s=5:5:30
    plot([iWashC(1)-.5 iWashC(s)],[s 0],'-','color',co*(30*1.5-(s-5))/30,'linewidth',4)
    plot([iWashC(s)-.5 iWashC(end)-.5],[0 0],'-','color',co*(30*1.5-(s-5))/30,'linewidth',4)
end

plot([iClampC1(1)-.5 iClampC1(end)+.5],-1*[15 15],'-','color',co,'linewidth',9)
for s=5:5:30
    plot([iWashC(1)-.5 iWashC(s)],-1*[s 0],'-','color',co*(30*1.5-(s-5))/30,'linewidth',4)
    plot([iWashC(s)-.5 iWashC(end)-.5],[0 0],'-','color',co*(30*1.5-(s-5))/30,'linewidth',4)
end
plot([iClampC2(1)-.5 iClampC2(end)+.5],-1*[15 15],'-','color',co,'linewidth',9)

plot([iWashC(30)-.5 iWashC(end)-.5],[0 0],'-','color',co,'linewidth',9)
