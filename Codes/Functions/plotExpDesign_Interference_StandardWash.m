function plotExpDesign_Interference_StandardWash(prot,col)
% prot - protocol
% col- colors
...
plot([iClampC1(1)-.5 iClampC1(end)+.5],[yLim(1) yLim(1)],'-','color',co,'linewidth',9)
plot([iWashC(1)-.5 iWashC(30)],[yLim(2) yLim(2)],'-','color',co,'linewidth',9)
