function [extreme_tSum,iSE_cluster_exttSum,nC_cand] = cluster_ttest2_multClust(TC1,TC2,nE,alphaCut,nC_out)
...
countCluster=0;
for e=1:nE
    [hVal(e),pVal(e),~,stats] = ttest2(TC2(:,e),TC1(:,e),'alpha',alphaCut);
    tVal(e)=stats.tstat;
    if hVal(e)==1 
        if e<nE
            if flagUpdate
